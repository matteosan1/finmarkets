...
class Test_Credit(unittest.TestCase):
  ...
  def test_cds(self):
    ...
    self.assertAlmostEqual(npv_prem, 303120.25, places=2)
    self.assertAlmostEqual(npv_def, 180903.50, places=2)
    self.assertAlmostEqual(npv, -122216.74, places=2)
  ...
  def test_bootstrap(self):
    ...
    b = np.array([0.90793109, 0.80383824, 0.70835319, 0.47934782, 0.29074158, 0.0654834])
  ...
  def test_bds(self):
    ...
    self.assertAlmostEqual(basket.npv(dc), 0.02039562101493969, delta=0.002)
    #print (basket.npv(dc))
